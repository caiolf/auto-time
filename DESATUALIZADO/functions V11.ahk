...
CriarGui2()
{
	global
    Gosub, darkMode
	Gui, 2: Add, GroupBox, x40 y60 w650 h400 hwndText0, Nova Inclusao de Tempo
    ;---------ENTRADA DE DADOS-------------
    Gui, 2: Add, Text, x600 y20 vText1, ESC para sair
    ...
    ;-------------RADIOS------------------
    Gui, 2: Add, Radio, x60 y280 vQuerEntrar gLabelReset hwndText5, Entrar.
    Gui, 2: Add, Radio, x160 y280 vQuerSair gLabelReset hwndText6, Sair.
    Gui, 2: Add, Radio, x260 y280 vQuerUmDia gLabelUmDia hwndText7, Entrar um dia completo.
    Gui, 2: Add, Radio, x500 y280 HwndManutencao vQuerMaisDia gLabelMaisDia hwndText8, Entrar varios dias.
    ...
    Gui, 2: Add, Picture, x350 y100 w300 h-1 vCebra_preto,\\servidor\desenv\USUARIOS\Caio\IMAGENS\cebra_transparente.png
    Gui, 2: Add, Picture, x350 y100 w300 h-1 vCebra_branco hidden,\\servidor\desenv\USUARIOS\Caio\IMAGENS\cebra_transparente_mais_branco.png  
    Gui, 2: Add, Picture, x265 y5 w200 h-1, \\servidor\desenv\USUARIOS\Caio\IMAGENS\auto-time-dragon.png
    ;-------------BUTTONS-----------------
    ...
    Gui, 2: Add, Button, x435 y480 gHelp, HELP
    Gui, 2: Add, Button, x220 y108 HwndConsultsige vConsultarSige gCONSULTANDO_SIGE Disabled, Modificar
    AddToolTip(Consultsige, "Clique aqui para modificar a ASSTEC selecionada")
    Gui, 2: Add, Button, x220 y228 HwndConsult vConsultar gCONSULTANDO Disabled, Consultar
    AddToolTip(Consult, "Clique aqui para consultar sua entrada de tempo no sige")
    Gui, 2: Add, Button, x285 y480 gSIGE, SIGE
    ;----------CHECK BOX------------------
...
RotinaDeTempo(Estado, ASSTEC, ETAPA, PESSOA)
{
    ...
    switch ETAPA ;Máquina de acordo com a ETAPA
    {
        ...
        case "P10":   SendInput, 35{Tab}
        case "P11":   SendInput, 35{Tab}
        case "P12":   SendInput, 35{Tab}
